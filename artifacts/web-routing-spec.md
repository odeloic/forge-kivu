...
authenticated /workshop
         ...
         /workshop/projects/:id                 ~~four tabs on one route~~ three tabs on one route (workshop-projects-views.md, One tab)
...
| `/workshop/projects/:id` | `GET /projects/:id`, `GET /projects/:id/boqs`, `GET /boqs/:id`, `POST /projects/:projectId/boqs`, `PUT`/`DELETE /projects/:id/phases/:phase` | ~~the four tabs read one project~~ the three tabs read one project |
...
7. ~~Project sub-pages are real routes (`/workshop/projects/:id/overview`) rather than
   ...
   Project detail is ~~four~~ three tabs on one route (`/workshop/projects/:id`), selected by a
